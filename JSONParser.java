...
public class JSONParser {
    ...
    public String sendReq(String strUrl, int reqType, String jsonData) throws IOException {
        String jsonString = "";
    ...
    public String[] sendPostReq(String strurl, String jsonData)
        ...
        conn.setRequestProperty("Authorization", "JWT " + UserDataPreferences.getToken(context));
        conn.setRequestMethod("POST");
...
//        conn.setConnectTimeout(1000);
    ...
    public String sendMultiPartRequest(Context context, String url, MultipartEntity multipartEntity) {
        ...
        try {
            ...
            httpPost.setHeader("Authorization", "Bearer " + UserDataPreferences.getToken(context));
